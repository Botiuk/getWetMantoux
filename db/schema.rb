...
ActiveRecord::Schema[7.2].define(version: 2024_02_24_201719) do
  ...
  create_table "doctors", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "doctor_status", default: 0, null: false
  ...
  create_table "personal_cards", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_personal_cards_on_user_id", unique: true
  end
  ...
  add_foreign_key "personal_cards", "users"
